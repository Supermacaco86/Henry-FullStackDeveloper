...
/*
$  BIND
* Escribir código, que al llamar al método getNombre poder obtener primero el nombre del instructor y luego el nombre del alumno.
? Modificar los undefined por el código correspondiente en cada caso
* Pista, tenes que bindear el this!
*/
var instructor = {nombre: "Franco", edad: 25}
var alumno = {nombre: "Juan",curso: "FullStack"}
function getNombre(){
  return this.nombre;
}
